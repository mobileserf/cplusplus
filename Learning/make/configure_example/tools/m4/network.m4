...
dnl
dnl MSERF_CHECK_LOOPBACK_IFACE: try to figure out default loopback interface
dnl
AC_DEFUN([MSERF_CHECK_LOOPBACK_IFACE], [
...
dnl
AC_DEFUN([MSERF_CHECK_MACRO_IN6_IS_ADDR_UNSPECIFIED], [
